...
public class DeleteQuestion extends javax.swing.JFrame {
    ...
    public DeleteQuestion(TeacherMain teacherMain) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btBackToQuestion1 = new javax.swing.JButton();
        ...
        btBackToQuestion = new javax.swing.JButton();
        ...
        btBackToQuestion1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/deletebt.jpg"))); // NOI18N
        btBackToQuestion1.setEnabled(false);
        btBackToQuestion1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btBackToQuestion1MousePressed(evt);
            }
        });
        btBackToQuestion1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btBackToQuestion1ActionPerformed(evt);
            }
        });
        jPanel7.add(btBackToQuestion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1680, 960, 190, 60));

        txtModule.setFont(new java.awt.Font("Microsoft Himalaya", 1, 50)); // NOI18N
        txtModule.setForeground(new java.awt.Color(255, 255, 255));
        txtModule.setText("Module  Name");
        jPanel7.add(txtModule, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 970, 390, 60));
        ...
        btBackToQuestion.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/btBackToQuestions.jpg"))); // NOI18N
        btBackToQuestion.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btBackToQuestionMousePressed(evt);
            }
        });
        btBackToQuestion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btBackToQuestionActionPerformed(evt);
            }
        });
        jPanel7.add(btBackToQuestion, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 960, 290, 60));
        ...
        jPanel7.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 70, 810, 110));
    ...
    private void btBackToQuestionMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btBackToQuestionMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btBackToQuestionMousePressed

    private void btBackToQuestionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBackToQuestionActionPerformed
        new QuestionsForm(teacherMain).setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btBackToQuestionActionPerformed
    ...
    private void btBackToQuestion1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btBackToQuestion1MousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btBackToQuestion1MousePressed

    private void btBackToQuestion1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBackToQuestion1ActionPerformed
        int res = JOptionPane.showConfirmDialog(this, "Are You Sure You want to Delete..??");
        if (res == 0) {
            try {
                QuestionController questionController = ServerConnector.getServerConnector().getQuestionController();
                boolean isDeleted = questionController.deleteQuestion(delId);

                if (isDeleted) {
                    JOptionPane.showMessageDialog(this, "Question Deletion Failed....");
                } else {
                    JOptionPane.showMessageDialog(this, "Question Deleted Successfully....");
                    new DeleteQuestion(teacherMain).setVisible(true);
                    this.dispose();
                }
            } catch (RemoteException ex) {
    ...
    }//GEN-LAST:event_btBackToQuestion1ActionPerformed
    ...
    private javax.swing.JButton btBackToQuestion;
    private javax.swing.JButton btBackToQuestion1;
    ...
    private void addQuestions(String module) {
        try {
            ...
            Logger.getLogger(ViewQuestions.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void previewQuestion() {
        ...
        for (Question question : readQuestionsModule) {
            if (selectedValue.equals(question.getQuestion())) {
                ...
                txtModule.setText(question.getModule());
                delId = question.getQid();
                btBackToQuestion1.setEnabled(true);
            }
        }
    }
