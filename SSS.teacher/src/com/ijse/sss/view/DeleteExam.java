...
public class DeleteExam extends javax.swing.JFrame {
    ...
    public DeleteExam(TeacherMain teacherMain) {
        initComponents();
            ...
            public void run() {
                while (true) {
                    ...
                    try {
                        ...
                        Logger.getLogger(DeleteExam.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }).start();
    ...
    private void initComponents() {
        ...
        jPanel1.add(lblCount, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 450, 90, 60));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/deleteSmall.jpg"))); // NOI18N
        ...
        jPanel1.add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 880, 330, 40));

        jRadioButton4.setFont(new java.awt.Font("Tahoma", 1, 30)); // NOI18N
        jRadioButton4.setForeground(new java.awt.Color(255, 255, 255));
        jRadioButton4.setText("Answer 3");
        jRadioButton4.setOpaque(false);
        jPanel1.add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 880, 330, 40));
        ...
        jPanel1.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 800, 330, 40));
        ...
        jPanel1.add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 800, 330, 40));

        jLabel27.setBackground(new java.awt.Color(51, 153, 0));
        jLabel27.setOpaque(true);
        jPanel1.add(jLabel27, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 800, 330, 40));
        ...
        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 560, 860, -1));
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 530, 900, 500));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try {
            String delModule = (String) txtExamName.getSelectedItem();
            String delQuestion = (String) txtExamName.getSelectedItem();
            String msgQ = "\"" + delQuestion + " : " + delModule + "\"";

            ExamController examController = ServerConnector.getServerConnector().getExamController();
            boolean isDeleted = examController.deleteExam(delQid);

            if (isDeleted) {
                JOptionPane.showMessageDialog(this, "Exam Deletion Failed....");
            } else {
                JOptionPane.showMessageDialog(this, "Exam Delete Successfully....");
                StudentController studentController = ServerConnector.getServerConnector().getStudentController();
                studentController.previewNotification("Exam " + msgQ + " Canceled...");
                new ExamForm(teacherMain).setVisible(true);
                this.dispose();
            }
        } catch (RemoteException ex) {
