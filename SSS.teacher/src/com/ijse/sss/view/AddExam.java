...
public class AddExam extends javax.swing.JFrame {
    ...
    public AddExam(TeacherMain teacherMain) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 190, 950, 330));
        ...
        jButton5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/createSmall.jpg"))); // NOI18N
        ...
        jPanel1.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1730, 870, 140, 60));
        ...
        jPanel1.add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1460, 820, 420, 40));
        ...
        jPanel1.add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 820, 420, 40));
        ...
        jPanel1.add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1460, 770, 420, 40));
    ...
    jPanel1.add(txtModule, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 600, 540, 50));
    ...
    jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 600, 260, 50));

    jLabel6.setFont(new java.awt.Font("Microsoft Himalaya", 1, 60)); // NOI18N
    jLabel6.setForeground(new java.awt.Color(255, 255, 255));
    jLabel6.setText(":");
    jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 580, 30, 100));
    ...
    txtName.setFont(new java.awt.Font("Microsoft Himalaya", 0, 40)); // NOI18N
    ...
    jPanel1.add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 210, 540, 40));
    ...
    jPanel1.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 580, 900, 450));
    ...
    jPanel1.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 190, 950, 330));
    ...
    jPanel1.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 900, 380));
    ...
    jPanel1.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 530, 950, 410));
    ...
    private void lstQstMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstQstMouseClicked
        if (txtName.getText().equals("") || txtExamCode.getText().equals("")) {
        ...
        if (isCan) {
            for (Question moduledQuestion : moduledQuestions) {
                if (moduledQuestion.getQid().equals(selectedQid)) {
                    Object[] row = {selectedQid, moduledQuestion.getQuestion(), moduledQuestion.getModule()};
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (timeIs >= 10) {
            try {
                ...
                boolean isWritten = examController.writeExam(exam);
                ...
                if (isWritten) {
                    ...
                    studentController.previewNotification("New Exam " + newTopic + " Added....");
                    new ExamForm(teacherMain).setVisible(true);
                    this.dispose();
                } else {
