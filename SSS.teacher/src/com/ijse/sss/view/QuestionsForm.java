...
public class QuestionsForm extends javax.swing.JFrame {
    ...
    public QuestionsForm(TeacherMain teacherMain) {
        initComponents();
    ...
    private void addQuestion() {
        try {
            ...
            for (Question readAllQuestion : readAllQuestions) {
                defaultListModel.addElement(readAllQuestion.getQuestion());
            }
    ...
    private void initComponents() {
        ...
        btView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/viewQuestion.jpg"))); // NOI18N
        ...
        lstQst.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        ...
        jLabel5.setText("Existing Questions");
        jPanel5.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 230, 570, 90));

        btChange.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/changeQuestion.jpg"))); // NOI18N
        ...
        btCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/insertQuestion.jpg"))); // NOI18N
        ...
        btDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/deleteQuestion.jpg"))); // NOI18N
        ...
        jPanel5.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 80, 370, 90));
    ...
    private void btViewMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btViewMouseEntered
        btView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/viewQuestionSel.jpg")));
    ...
    private void btViewMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btViewMouseExited
        btView.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/viewQuestion.jpg")));
    }//GEN-LAST:event_btViewMouseExited

    private void btViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btViewActionPerformed
        new ViewQuestions(teacherMain).setVisible(true);
        this.dispose();
    ...
    private void btChangeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btChangeMouseEntered
        btChange.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/changeQuestionSel.jpg")));
    ...
    private void btChangeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btChangeMouseExited
        btChange.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/changeQuestion.jpg")));
    ...
    private void btChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btChangeActionPerformed
        new ChangeQuestion(teacherMain).setVisible(true);
        this.dispose();
    ...
    private void btCreateMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btCreateMouseEntered
        btCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/insertQuestionSel.jpg")));
    ...
    private void btCreateMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btCreateMouseExited
        btCreate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/insertQuestion.jpg")));
    }//GEN-LAST:event_btCreateMouseExited

    private void btCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCreateActionPerformed
        this.dispose();
        new AddQuestion(teacherMain).setVisible(true);
    }//GEN-LAST:event_btCreateActionPerformed

    private void btDeleteMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btDeleteMouseEntered
        btDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/deleteQustionSel.jpg")));
    ...
    private void btDeleteMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btDeleteMouseExited
        btDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/ijse/sss/images/deleteQuestion.jpg")));
