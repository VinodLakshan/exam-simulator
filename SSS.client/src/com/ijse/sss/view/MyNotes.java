...
public class MyNotes extends javax.swing.JFrame {
    ...
    public MyNotes(MainForm mainForm) {
        initComponents();
    ...
    private void addTopics() {
        ...
        try {
            ...
            topics = myNoteController.getMyNotesTopics(mainForm.getTitle(), "Student");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        String userName = mainForm.getTitle();
        String topic = txtMyNoteTopic.getText();

        MyNote myNote = new MyNote(selectedMid, topic, desc, userName, date, "Student");
